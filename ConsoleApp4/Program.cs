/* Завдання 4: Створіть додаток, який шукає у певному масиві:Мінімум.
Максимум.Середнє арифметичне.Суму.
Використовуйте масив «Task» для вирішенняданого завдання. */
using System;
using System.Linq;
